...
## 1.
Alpha MN UMAP with cell clustering into ff, fr, sf
...
## 2.
Umap/pca graphical clustering for ag.combined
...
```{r}
finalgenes.visceral <- FeaturePlot(all.visceral, features = c('Pard3b', 'Tenm2', 'Hs6st2', 'Rxfp1', 'Gpc5', 'Grm8'), reduction = 'X_umap') + NoAxes()
ggsave(filename = paste(graph.save.dir, 'finalgenes.visceral.featureplot.pdf'), plot = finalgenes.visceral, device = 'pdf')

finalgenes.beta <- (FeaturePlot(all.beta, features = c('Pard3b', 'Tenm2', 'Hs6st2', 'Rxfp1', 'Gpc5', 'Grm8'), reduction = 'X_umap') + NoAxes())
